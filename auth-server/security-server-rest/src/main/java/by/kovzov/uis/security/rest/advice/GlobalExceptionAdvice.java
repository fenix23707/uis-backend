...
public class GlobalExceptionAdvice {
    ...
    @ExceptionHandler(securityenticationException.class)
    public ResponseEntity<?> securityenticationExceptionHandler(securityenticationException e) {
        return buildResponseEntity(e.getMessage(), HttpStatus.UNsecurityORIZED);
    }
